...
def generate_launch_description():
    ...
    # 生成一只新乌龟
    spawn1 = spawn(node_name="t2")
    spawn2 = spawn(node_name="t3", x=2.0, y=8.0,turtle_name="turtle3")
    spawn3 = spawn(node_name="t4", x=8.0, y=2.0, theta=1.57, turtle_name="turtle4")
    ...
    escort2 = escort(node_name="static_transform_publisher1",y="1",child_frame_id="escort2")
    escort3 = escort(node_name="static_transform_publisher1",y="-1",child_frame_id="escort3")
